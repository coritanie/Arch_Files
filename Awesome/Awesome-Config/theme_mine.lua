...
theme.menu_bg_normal                            = "#7493d2"
theme.menu_bg_focus                             = "#7493d2"
...
theme.taglist_squares_sel                       = theme.confdir .. "/icons/square_a_mine.png"
...
local mytextclock = wibox.widget.textclock(markup("#7493d2", "%A %d %B ") .. markup("#7493d2", ">") .. markup("#7493d2", " %H:%M "))
...
theme.weather = lain.widget.weather({
    city_id = 2647878, -- placeholder (Belgium)
    notification_preset = { font = "Noto Sans Mono Medium 10", fg = theme.fg_normal },
    weather_na_markup = markup.fontfg(theme.font, "#7493d2", "N/A "),
    settings = function()
        descr = weather_now["weather"][1]["description"]:lower()
        units = math.floor(weather_now["main"]["temp"])
        widget:set_markup(markup.fontfg(theme.font, "#7493d2", descr .. " @ " .. units .. "°C "))
    end
})
...
local temp = lain.widget.temp({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#7493d2", coretemp_now .. "°C "))
    end
})
...
local bat = lain.widget.bat({
    settings = function()
        ...
        widget:set_markup(markup.fontfg(theme.font, "#7493d2", perc .. " "))
    end
})
...
local memory = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#7493d2", mem_now.used .. "M "))
    end
})
